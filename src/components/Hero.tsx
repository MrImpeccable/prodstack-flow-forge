...
const Hero = () => {
  ...
  return (
    <section className="pt-5 pb-16 md:pt-8 md:pb-20 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                size="lg" 
                className="bg-red-600 hover:bg-red-700 text-white font-semibold px-8 py-4 text-lg border-2 border-red-800 shadow-lg"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-red-600 text-red-600 hover:bg-red-50 dark:hover:bg-red-950 px-8 py-4 text-lg font-semibold shadow-lg"
                onClick={() => navigate('/auth')}
              >
                Explore the Demo
              </Button>
